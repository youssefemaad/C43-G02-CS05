...
namespace Assignment05
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // passing by value: the value of the variable is passed to the function, so the original value is not changed.
            // passing by reference: the memory address of the variable is passed to the function, so the original value can be changed.
            ...
            // passing by value: a copy of the reference is passed, so the original object cannot be changed.
            // passing by reference: the actual reference (memory address) of the object is passed, so changes can modify the original object.
            int[] arr = { 1, 2, 3, 4, 5 };
            Console.WriteLine("Passing by value:");
...
﻿
>>>>>>> 7be922bee1c61dd82c52316eed85979ebda3da56
